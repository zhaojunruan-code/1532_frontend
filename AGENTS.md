...
- **Login route bug:** The umi-antd-admin login page redirects to `/home` after login, but no `/home` route exists in the routes config. Navigate directly to `/#/workplace` after login to access the dashboard. Mock credentials: `admin` / `123456`.
